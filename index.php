...
$journeys = new Maropost\Api\Journeys(1000, 'wTX-esFcYzEMjSLEqkdWgGcf8yR7osiROc9uU-CjJXQDxMshn_SM-Q');
...
// gets Journeys via Journeys api
$res = $journeys->get();
var_dump($res->getData());

// gets Journey campaigns
$res = $journeys->getCampaigns(357);
var_dump($res->getData());
