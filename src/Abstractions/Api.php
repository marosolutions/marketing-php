...
trait Api {
	 ...
	 * @return GetResult
	 */
	protected function _get(string $resource = null, array $params = [], string $overrideRootResource = null): GetResult
	{
	 ...
	 * @return GetResult
	 */
	protected function _put(string $resource, array $params, \stdClass $object = null, string $overrideRootResource = null) : GetResult
	{
		try {
			$url = $this->url($overrideRootResource);
			$url .= !empty($resource) ? '/' . $resource : '';
